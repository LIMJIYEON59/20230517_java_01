...
//	private static String resultRows;
//	private static String pageNo;
	...
	public String toString() {
		return "EvInfoVo [addr=" + addr + ", chargeTp=" + chargeTp + ", cpNm=" + cpNm + ", cpStat=" + cpStat + ", cpId="
							+ cpId + ", cpTp=" + cpTp + ", csId=" + csId + ", csNm=" + csNm + ", lat=" + lat + ", longi=" + longi
