...
//			int num1 = 5;
//			while(num1 >= 1) {         			//if나 while을 적어줘도된다
//				System.out.println(num1);
//				num1 = num1 -1;        			//화면에 뿌린다음에 줄여야한다. 안그러면 0도 나옴
//			}
...
//}
			...
			for( num1 =5 , num2 =1 ; num1>=1 ; num1 = num1-1 , num2++) {  //나열을 의미하는 ,를 쓴다
...
//			System.out.println(num9);
			...
			System.out.printf("%2d * %2d = %2d\n" , dan, su, dan*su);  //ln을 지우고 f 
			System.out.printf("%2d * %2d = %2d\n" , 9, 9, 81);
			System.out.printf("%2d * %2d = %2d\n" , dan, ++su, dan*++su);
			System.out.printf("%2d * %2d = %2d\n" , 9, 9, 81);
			System.out.println("======");
			dan =2;
			for(su=1; su<=9; su++) {			//전위증감을 쓰나 후위증감을 쓰나 결과값 똑같 
				System.out.printf("%2d * %2d = %2d\n" , dan, ++su, dan*su);
			}
			System.out.println(); //줄 구분 선
			dan =3;
			for(su=1; su<=9; su++) {			 
				System.out.printf("%2d * %2d = %2d\n" , dan, ++su, dan*su++);
			}
